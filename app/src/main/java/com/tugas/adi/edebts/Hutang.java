 ...
 */
public class Hutang extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab_hutang, container, false);

        numberList = (ListView) v.findViewById(R.id.ListHutang);
        ...
        numberList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(final AdapterView<?> arg0, View arg1, final int arg2, long arg3) {
                ...
                cursor = db.rawQuery("SELECT * FROM data WHERE (jenis='hutang' AND status='unpaid') ORDER BY _id DESC",null);
                ...
                Dialog dialog = new Dialog(getActivity(), "Hutang " + tempNama, "Nama \t: " + tempNama + "\nJumlah \t: " + tempNominal + "\nKet \t: " + tempDesk);
                    ...
                    dialog.setOnCancelButtonClickListener(new View.OnClickListener(){
                        ...
                        public void onClick(View v) {
                            ...
                            new SnackBar(getActivity(),
                                ...
                                public void onClick(View v) {
                                    SQLiteDatabase db = dbHelper.getReadableDatabase();
                                    String sqlundo = "INSERT INTO data values('" + id + "','" + tempNama + "','hutang'," + tempNominal + ",'" + tempDesk + "','unpaid')";
                                    db.execSQL(sqlundo);
                                    view();
                                    Toast.makeText(getActivity(), "Data Telah Dikembalikan", Toast.LENGTH_SHORT).show();
                                }
